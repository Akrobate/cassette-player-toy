...
module facadeCornerPiece(
    ...
    facadeCorner(
        ...
        x_branch_offset_thickness,
        x_branch_offset_lenght,

        y_branch_offset_thickness,
        y_branch_offset_lenght,

        correction_offset_thickness,
        correction_offset_length,

        throw_diameter,
        throw_depth,
        throw_x_margin,  // applies on both branches
        throw_y_margin,  // applies on both branches
        throw_z_margin
    );
}
